...
\begin{equation*}
\begin{split}
\bigg|f_{\mathrm{hat},y}(x) - & \bigg(1 - \frac{M}{2a} \cdot |x - y|\bigg)_+\bigg| \\[0.5em]
...
& \quad + \bigg|f_{\ReLU}\bigg(\frac{M}{2a} \cdot (x - y) - 1\bigg) - \max\bigg\{\frac{M}{2a} \cdot (x - y) - 1, 0\bigg\}\bigg|\\[0.5em] 
