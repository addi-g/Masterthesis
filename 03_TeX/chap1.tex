...
Mithilfe von $\max\{x, 0 \} = x \cdot \1_{[0, \infty)}(x)$, der Vorraussetzung, zweier Nulladdition und dem zweifachen Anwenden der Dreiecksungleichung erhalten wir$\colon$
\begin{equation*}
\begin{split}
|f_{ReLU}(x) - & \max\{x, 0\}|  \\
