...
\end{split}
\end{equation}
für eine Konstante $c > 0$ und Regularitätsterm $\lambda\|(a_{\bi,\bj})\|_2^2$ erhalten. Diese regularisierte lineare Kleinste-Quadrate Schätzung erhalten wir durch die Lösung des, in Gleichung~(\ref{les}) folgenden, linearen Gleichungssystems. Dafür definieren wir uns die Menge 
\begin{align*} 
