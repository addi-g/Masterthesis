...
\textbf{•} Es handelt sich hierbei um eine lokale Spline Interpolation, da die Bedingungen (\ref{induktiongl1}) und (\ref{induktiongl2}) für alle $x \in [-a, a]^d$ gelten.
\end{proof}
...
\end{equation}
ist. Hierbei ist $\mathbf{1}$ eine $S \times S$-Einheitsmatrix ist.
