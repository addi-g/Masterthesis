...
\label{min} 
\begin{split}
\varphi(a_{\bi,\bj}) & \coloneqq \sum_{i = 1}^n|Y_i - \tilde{m}_n(X_i)|^2 + \lambda\|(a_{\bi,\bj})\|_2^2 \\
...
Gesucht ist also 
$$\big|\Bigl\{\bj \in [N]^d : |\bj|_1 \leq N \Bigr\}\big| \eqqcolon H.$$ 
...
was uns erlaubt eine obere Schranke für den absoluten Wert unserer Koeffizienten abzuleiten. (TBD) WOFÜR BRAUCH ICH DAS DENN? WEGLASSEN!
\end{bemnumber}